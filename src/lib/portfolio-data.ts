...
export const services = [
  ...
  },
  {
    ...
    description: "Secure online payment solutions with all major Indian gateways.",
    items: ["Razorpay", "UPI Payments", "Google Pay", "PhonePe", "Cards"],
    icon: "₹",
  },
  {
    title: "Cloud Deployment",
    description: "Production-ready hosting and continuous delivery pipelines.",
    items: ["Vercel Hosting", "GitHub CI/CD", "Custom Domains", "SSL & Security", "Analytics"],
    icon: "☁",
  },
];

export const techStack = {
  Frontend: ["Next.js", "React.js", "TypeScript", "JavaScript", "HTML5", "CSS3", "Tailwind CSS"],
...
export const process = [
  { n: "01", t: "Discovery", d: "Understanding business requirements and objectives in depth." },
  { n: "02", t: "Planning", d: "Project architecture, scope and roadmap creation." },
  { n: "03", t: "UI/UX Design", d: "Crafting intuitive, conversion-focused user experiences." },
  { n: "04", t: "Development", d: "Building scalable, optimized and maintainable solutions." },
  { n: "05", t: "Testing", d: "Quality assurance, performance and security validation." },
  { n: "06", t: "Deployment", d: "Launching secure, production-ready environments." },
  { n: "07", t: "Support", d: "Ongoing maintenance, monitoring and feature enhancements." },
];
